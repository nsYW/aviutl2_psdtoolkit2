...
TEST("build_exclusive_values_with_objects", function()
	-- Objects (like Blinker, LipSync) should pass through unchanged
	...
	-- Strings get prefix, objects pass through
	...
	TEST_MSG("Objects should pass through unchanged")
end)
