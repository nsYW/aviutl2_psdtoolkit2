 ...
 */
void ptk_logf_set_handle(struct aviutl2_log_handle *handle);
 ...
 */
void ptk_logf_verbose(struct ov_error const *const err, char const *const reference, char const *const format, ...);
 ...
 * @param format Printf-style format string (can be NULL if err is provided)
 */
void ptk_logf_info(struct ov_error const *const err, char const *const reference, char const *const format, ...);
