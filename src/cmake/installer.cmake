...
set(PTK_INSTALLER_VERSION "${version}")
...
string(REPLACE "/" "\\" PTK_BUILD_OUTPUT_DIR "${build_output_dir}")
string(REPLACE "/" "\\" PTK_README_FILE "${local_dir}/README.md")
string(REPLACE "/" "\\" PTK_INSTALLER_OUTPUT_DIR "${output_dir}")
if(CHINESE_SIMPLIFIED_ISL_FILE)
  string(REPLACE "/" "\\" PTK_CHINESE_SIMPLIFIED_ISL "${CHINESE_SIMPLIFIED_ISL_FILE}")
else()
  set(PTK_CHINESE_SIMPLIFIED_ISL "")
endif()
...
message(STATUS "  Version: ${PTK_INSTALLER_VERSION}")
message(STATUS "  Build output: ${PTK_BUILD_OUTPUT_DIR}")
message(STATUS "  Installer output: ${PTK_INSTALLER_OUTPUT_DIR}")