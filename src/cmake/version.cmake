...
foreach(name IN ITEMS
  PTK_REQUIRED_AVIUTL2_VERSION_UINT32
  PTK_REQUIRED_AVIUTL2_VERSION_NAME
  PTK_REQUIRED_AVIUTL2_VERSION_DISPLAY
  PTK_REQUIRED_GCMZDROPS_VERSION_UINT32
  PTK_REQUIRED_GCMZDROPS_VERSION_TAG
)
  if(NOT DEFINED ${name} OR "${${name}}" STREQUAL "")
    message(FATAL_ERROR "Required variable not defined: ${name}")
  endif()
endforeach()
...
if(_version_changed)
  ...
  file(APPEND "${_env_file}" "PTK_VERSION=${_git_tag}\n")
  file(APPEND "${_env_file}" "PTK_REVISION=${_git_revision}\n")
  file(APPEND "${_env_file}" "PTK_REQUIRED_AVIUTL2_VERSION_UINT32=${PTK_REQUIRED_AVIUTL2_VERSION_UINT32}\n")
  file(APPEND "${_env_file}" "PTK_REQUIRED_AVIUTL2_VERSION_NAME=${PTK_REQUIRED_AVIUTL2_VERSION_NAME}\n")
  file(APPEND "${_env_file}" "PTK_REQUIRED_AVIUTL2_VERSION_DISPLAY=${PTK_REQUIRED_AVIUTL2_VERSION_DISPLAY}\n")
  file(APPEND "${_env_file}" "PTK_REQUIRED_GCMZDROPS_VERSION_UINT32=${PTK_REQUIRED_GCMZDROPS_VERSION_UINT32}\n")
  file(APPEND "${_env_file}" "PTK_REQUIRED_GCMZDROPS_VERSION_TAG=${PTK_REQUIRED_GCMZDROPS_VERSION_TAG}\n")
